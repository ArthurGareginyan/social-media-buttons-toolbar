...
When contributing to "Social Media Buttons Toolbar" you have to follow some conventions and a simple workflow. It allows me to handle the requests quickly and ensure best quality
for the "Social Media Buttons Toolbar" core code.
...
The preferred way to report bugs is to use the [GitHub issue tracker](https://github.com/ArthurGareginyan/social-media-buttons-toolbar/issues). Before reporting a bug, read these pointers.
...
- "Social Media Buttons Toolbar" is maintained by me. I don't owe you anything, so be polite. Reports with an indignant or belligerent tone tend to be moved to the bottom of the pile.
...
- Mention which release of "Social Media Buttons Toolbar" you're using.
...
- Fork [Social Media Buttons Toolbar](https://github.com/ArthurGareginyan/social-media-buttons-toolbar)
...
By contributing code to "Social Media Buttons Toolbar" you:
